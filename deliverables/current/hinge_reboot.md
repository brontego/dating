...
Use Hinge in a real but bounded way without turning it into another pressure pile, while recovering cleanly from the Anna disappointment and building a ChatGPT copilot that reduces friction without flattening your voice.

## Minimum viable reboot

1. Do not chase Anna or keep reopening that thread mentally.
2. Build the profile source packet and self-interview prompt for the ChatGPT project.
3. Do one bounded screening or opener block.
4. Only do a profile pass if the AI-context work reveals something obviously stale or missing.

## Time caps

- daily app block: `10 to 20` minutes
- screening pass: `10 to 15` minutes
- project build block: `20 to 40` minutes
...
- the Anna lane is processed honestly instead of artificially extended
- the ChatGPT project has usable instructions and a real self-context packet
- the profile feels current enough to use without triggering a perfectionism project
- at least a few good likes or openers go out across the week unless the queue is unusually weak
